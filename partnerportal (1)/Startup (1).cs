...
namespace partnerportal
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<Service.IEmailService, MailKitService>();

            services.AddIdentity<ClmPartner, IdentityRole>(options => {
                //options.SignIn.RequireConfirmedEmail = true;
                options.User.RequireUniqueEmail = true;
            })
            .AddSignInManager<SignInManager<ClmPartner>>()
            .AddEntityFrameworkStores<toolkittpmpsandboxContext>()
